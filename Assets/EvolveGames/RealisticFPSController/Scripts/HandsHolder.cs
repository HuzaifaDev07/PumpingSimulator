...
namespace EvolveGames
{
    public class HandsHolder : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.LeftShift)) AmountValue = Amount * SprintAmount;
            else if (ControlFreak2.CF2Input.GetKeyUp(KeyCode.LeftShift)) AmountValue = Amount / SprintAmount;
