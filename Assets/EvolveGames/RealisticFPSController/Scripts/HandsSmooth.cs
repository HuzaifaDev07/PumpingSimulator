...
namespace EvolveGames
{
    public class HandsSmooth : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (EnabledCroughRotation && ControlFreak2.CF2Input.GetKey(CroughKey)) CroughRotation = Mathf.Lerp(CroughRotation, RotationCroughMultipler, RotationCroughSmooth * Time.deltaTime);
